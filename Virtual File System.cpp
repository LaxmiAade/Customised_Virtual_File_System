...
void ManPageDisplay(char Name[])
{
    ...
    {
        printf("About : It is used to display information of file\n");
            ...
            )
{
    ...
    strncpy(uareaobj.UFDT[fd]->ptrinode->Buffer + uareaobj.UFDT[fd]->WriteOffset, data, size);   /// It is Logic
...
//  Description         :       It is used to Display Statistical Information of a File
//  Input               :       File Name                             
//  Output              :       Returns 0 on success or error code on failure....
//  Author              :       Laxmi Rahul Rathod
//  Date                :       22/01/2026
//
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp("write",Command[0]) == 0)
            {
                ...
                {
                    printf("Error : Unable to write as there is no such Space\n");
                }
                else
                {
